...
const SUITES = [
  ...
  { label:'redeployment',       harness:'dom-storage-server.js', assert:true, files:['37-redeployment.js'] },
  { label:'field-promotions',   harness:'dom-storage-server.js', assert:true, files:['38-field-promotions.js'] },
  { label:'reinforcement-wave', harness:'dom-storage-server.js', assert:true, files:['39-reinforcement-wave.js'] },
  { label:'campaign-map',       harness:'dom-storage-server.js', assert:true, files:['40-campaign-map.js'] },
  { label:'the-camp',           harness:'dom-storage-server.js', assert:true, files:['41-the-camp.js'] },
  { label:'win-streaks',        harness:'dom-storage-server.js', assert:true, files:['42-win-streaks.js'] },
  { label:'draft-augments',     harness:'dom-storage-server.js', assert:true, files:['43-draft-augments.js'] },
  { label:'set-bonuses',        harness:'dom-storage-server.js', assert:true, files:['44-set-bonuses.js'] },
  { label:'scavenger-caravan',  harness:'dom-storage-server.js', assert:true, files:['45-scavenger-caravan.js'] },
